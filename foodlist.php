...
<?php
  ...
  ?>
           <ul class="nav navbar-nav navbar-right">
            ...
            <li class="active" ><a href="foodlist.php"><span class="glyphicon glyphicon-cutlery"></span> Order </a></li>
...
<div class="jumbotron">
  <div class="container text-center">
    <h1>We are Bach Khoa Smart Food, we serve tasty food.</h1>      
...
<input type="submit" name="add" style="margin-top:5px;" class="btn btn-success" value="Thêm vào giỏ">
</div>
</form>
