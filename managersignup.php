<html>
  ...
  <body>
    ...
    <div class="container">
    <div class="jumbotron">
     <h1><br> Welcome Manager to <span class="edit"> Bach Khoa Smart Food Court </span></h1>
     <br>
   <p>Khu ẩm thực phong cách Bách Khoa</p>
    </div>
    </div>
  ...
  <br>
  <p> Bach Khoa Smart Food Court| &copy All Rights Reserved </p>
  <br>
  </footer>
</html>