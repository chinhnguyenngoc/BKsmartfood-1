...
<td><?php echo number_format($values["food_quantity"] * $values["food_price"]); ?>VND</td>
...
<td align="right"> <?php echo number_format($total); ?>VND</td>
<td></td>
</tr>
</table>
<?php
  echo '<a href="cart.php?action=empty"><button class="btn btn-danger"> Xóa Tất Cả</button></a>&nbsp;<a href="foodlist.php"><button class="btn btn-warning">Thêm Món</button></a>&nbsp;<a href="payment.php"><button class="btn btn-success pull-right">Thanh Toán</button></a>';
?>
</div>
...
if(empty($_SESSION["cart"]))
{
  ...
  <div class="container">
      <div class="jumbotron">
        ...
        <p>Oops! There is no food here. Go back and <a href="foodlist.php">order now.</a></p>
